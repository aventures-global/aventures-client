...
export default function ServiceRequest({ kind, title, description }: ServiceRequestProps) {
    ...
    <div className="min-h-svh bg-ink">
      ...
      <div className="relative overflow-hidden border-b border-white/5 bg-ink-soft">
        ...
        <div className="site-container relative z-10 pb-12 pt-36">
          <p className="text-sm text-gold">Request desk</p>
          <motion.h1
      ...
      <div className="site-container grid gap-12 py-14 lg:grid-cols-2">
        ...
        >
          {site ? (
            <ServiceRequestForm kind={kind} fallbackEmail={site.email} />
          ) : (
        ...
        >
          <p className="leading-relaxed text-muted">
            Share the details below and we will source options that fit your dates and
            budget. There is no live inventory on this page — a host follows up by email
            or phone.
          </p>
          {site && (
            <div className="space-y-4">
